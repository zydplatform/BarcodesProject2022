$(document).ready(function () {
  $('#addbusiness').attr('disabled',true);
       var businessName;
          ...
          var email;
           ...
           if($('#businessName').val().length !=0 &&$('#businessOwnerShip').val().length !=0 &&$('#physicalAdress').val().length !=0 &&$('#businessEmail').val().length !=0 &&$('#registrationNumber').val().length !=0 &&$('#tinNumber').val().length !=0 &&$('#password').val().length !=0 &&$('#selectline').val().length !=0 &&
$('#selecttype').val().length !=0 &&$('#confirmPassword').val().length !=0 &&$('#country').val().length !=0            ){
  debugger
  $('#addbusiness').attr('disabled',false);
}
else{
    $('#addbusiness').attr('disabled',true);
}
